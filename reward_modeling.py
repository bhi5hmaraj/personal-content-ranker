...
def preprocess_function(examples, truncate=512):
    token_to_char_multiplier = 3
    new_examples = {
        "input_ids_chosen": [],
    ...
    for chosen, rejected in zip(examples["chosen"], examples["rejected"]):
        ...
        tokenized_chosen = tokenizer(chosen[:truncate * token_to_char_multiplier])
        tokenized_rejected = tokenizer(rejected[:truncate * token_to_char_multiplier])
